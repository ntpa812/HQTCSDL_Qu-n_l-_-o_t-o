        ...
        <div class="modal-body">
            <form action="{{ route('sinhviens.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="maNganh" id="maNganh" required="">
                        <option value="">Chọn ngành</option>
                        @foreach ($ng as $nganh)
                        <option value="{{ $nganh['maNganh'] }}">{{ $nganh['maNganh'] }} - {{ $nganh['tenNganh'] }}
                        </option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="queQuan" id="queQuan" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tenDN" id="tenDN" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="soCCCD" id="soCCCD" required>
                </div>
                <div class="form-group">
                    <label for="anhThe">Ảnh Thẻ</label>
                    <input type="text" class="form-control" name="anhThe" id="anhThe" accept="image/*">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="khoaHoc" id="khoaHoc" required>
                </div>
                <div class="form-group">
