    ...
    <div class="container-xl">
        <div class="table-responsive">
            <div class="table-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="{{ route('sinhviens.create') }}" class="btn btn-success">
                                <i class="material-icons">&#xE147;</i> <span>Thêm Sinh Viên</span>
                            </a>
                        </div>
                    </div>
                </div>
                <form action="{{ route('sinhviens.search') }}" method="GET">
                ...
                <div class="clearfix">
                    <div class="hint-text">Hiển thị <b>{{ $sv->count() }}</b> trên tổng số
                        <b>{{ $sv->total() }}</b> sinh viên
                    </div>
                    <ul class="pagination">
                        {{ $sv->links('pagination::bootstrap-4') }}
                    </ul>
                </div>
            </div>
        </div>
